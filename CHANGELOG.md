...
- feat: |Branding| Page title set to "Mirai Tech Store", footer updated with WhatsApp contact and custom copyright

### Improvements

- improve: |UX| Hide credential popup from end users (only visible in Operator mode), remove Full Mode link for non-operators
- improve: |UX| Remove "Pengguna" (User) tab from header menu
- improve: |Docs| Remove Chinese docs (README.md, CHANGELOG.md), make English the default
- improve: |Footer| Add WhatsApp icon + "Hubungi Admin 085877961552" link, copyright now reads "© 2026 Mirai Tech Store | faturismee.online"
